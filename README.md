...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/falling-sky-2d8b
```

A live public deployment of this template is available at [https://falling-sky-2d8b.templates.workers.dev](https://falling-sky-2d8b.templates.workers.dev)
